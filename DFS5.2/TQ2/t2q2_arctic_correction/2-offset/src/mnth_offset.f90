PROGRAM MNTH_OFFSET
  ...
  INTEGER, PARAMETER ::   &
       ...
       &   jytr1 = 1999,  &
       &   jytr2 = 1999,  &
       &   n_smth = 8      ! number of iterations for smoothing fields
  ...
  & cmask='/fsnet/data/meom/workdir/dussin/MESHMASKS/lsm_erainterim.nc', &
  ...
  CHARACTER(len=256), PARAMETER ::   &
       ...
       & cf_pt ='/home/users/dussin/DFS5/DFS5.2/TQ2/t2q2_arctic_correction/0-data/t2_POLES-ERAi_1979-1998.nc',  &
       !!
       ...
       & cf_p0 = '/fsnet/data/meom/workdir/dussin/TMPDIR_TQ2_CORR_ANTARCTIC/monthly/drowned_t2_ERAinterim_corr_antarctic_y1979-1998_monthly.nc'
  !!
