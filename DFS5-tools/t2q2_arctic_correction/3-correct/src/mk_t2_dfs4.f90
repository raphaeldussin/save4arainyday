...
PROGRAM MK_T2_DFS4
  ...
  CHARACTER(len=512), PARAMETER :: &
       ...
       &  cf_ice_mm ='/data2/dussin/WORK/PREPA_GRD100/forcages/CORRECTION_ARCTIC/ifrac_SSMI-ERAi_1979-1998.nc', &
       &  cd_out  = './'
  !!
  INTEGER, PARAMETER ::   &
       ni     = 512,      &
...
!       & cv_im  = 'ice_mask'
  ...
  DO jy = jy1, jyf
     ...
     IF ( jy == jy1 ) THEN
        !cf_m = '/data2/dussin/WORK/PREPA_GRD100/forcages/CORRECTION_ARCTIC/offset_poles/offset_poles-eraint_1989-2009.nc'
...
!        PRINT *, jy,    jm,    jd,  jdm,          js 
     ...
     !!
     WRITE(cf_m1, '("xmd_offset_",i4,".nc")'), jy
     WRITE(cf_m2, '("xid_offset_",i4,".nc")'), jy
     !!
     DO jt = 1, nday
        !!
